...
template <typename T, std::size_t N> struct matrix_base
{
  ...
  template <typename... Dims> matrix_base (Dims... dims);
  ...
  template <typename Act> void apply_scalar (T *self, const T &value, Act act);

  template <typename Act> void apply_matrix (T *self, const T *data, Act act);
...
inline matrix_base<T, N>::matrix_base (Dims... dims)
// : extents{dims...}
{
...
template <typename T, std::size_t N>
inline matrix_base<T, N>::matrix_base (Matrix_initializer<T, N> list)
{
...
template <typename T, std::size_t N>
inline matrix_base<T, N>::matrix_base (const array_type &sz,
...
template <typename T, std::size_t N>
template <typename... Dims>
inline std::size_t matrix_base<T, N>::operator() (Dims... dims) const
{
