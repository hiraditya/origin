...
find_end (R1 &&range1, const R2 &range2)
{
  using std::begin;
  using std::end;
  return std::find_end (begin (range1), end (range1), begin (range2),
                        end (range2));
}
...
search (R1 &&range1, const R2 &range2)
{
  using std::begin;
  using std::end;
  return std::search (begin (range1), end (range1), begin (range2),
                      end (range2));
}
...
range_transform (const R1 &range1, const R2 &range2, R3 &&range3, Op op)
{
  using std::begin;
  using std::end;
  return std::transform (begin (range1), end (range1), begin (range2),
                         begin (range3), op);
}
...
replace_copy (const R1 &range1, R2 &&range2, const T &orig, const T &value)
{
  using std::begin;
  using std::end;
  return std::replace_copy (begin (range1), end (range1), begin (range2), orig,
                            value);
}
...
replace_copy_if (const R1 &range1, R2 &&range2, P pred, const T &value)
{
  using std::begin;
  using std::end;
  return std::replace_copy_if (begin (range1), end (range1), begin (range2),
                               pred, value);
}
...
remove_copy (const R1 &range1, R2 &&range2, const T &value)
{
  using std::begin;
  using std::end;
  return std::remove_copy (begin (range1), end (range1), begin (range2),
                           value);
}
...
remove_copy_if (const R1 &range1, R2 &&range2, P pred)
{
  using std::begin;
  using std::end;
  return std::remove_copy_if (begin (range1), end (range1), begin (range2),
                              pred);
}
...
partition_copy (const R1 &range1, R2 &&true_range, R3 &&false_range, P pred)
{
  using std::begin;
  using std::end;
  return std::partition_copy (begin (range1), end (range1), begin (true_range),
                              begin (false_range), pred);
}
...
partial_sort_copy (const R1 &range1, R2 &&range2)
{
  using std::begin;
  using std::end;
  return std::partial_sort_copy (begin (range1), end (range1), begin (range2),
                                 end (range2));
}
...
merge (const R1 &range1, const R2 &range2, R3 &&range3)
{
  using std::begin;
  using std::end;
  return std::merge (begin (range1), end (range1), begin (range2),
                     end (range2), begin (range3));
}
...
includes (const R1 &range1, const R2 &range2)
{
  using std::begin;
  using std::end;
  return std::includes (begin (range1), end (range1), begin (range2),
                        end (range2));
}
...
set_union (const R1 &range1, const R2 &range2, R3 &&result)
{
  using std::begin;
  using std::end;
  return std::set_union (begin (range1), end (range1), begin (range2),
                         end (range2), begin (result));
}
...
set_intersection (const R1 &range1, const R2 &range2, R3 &&result)
{
  using std::begin;
  using std::end;
  return std::set_intersection (begin (range1), end (range1), begin (range2),
                                end (range2), begin (result));
}
...
set_difference (const R1 &range1, const R2 &range2, R3 &&result)
{
  using std::begin;
  using std::end;
  return std::set_difference (begin (range1), end (range1), begin (range2),
                              end (range2), begin (result));
}
...
template <typename R>
inline auto min (R &&range) -> decltype (*min_element (range))
{
  return *min_element (range);
}

template <typename R, typename C>
inline auto min (R &&range, C comp) -> decltype (*min_element (range, comp))
{
  return *min_element (range, comp);
}

template <typename R>
inline auto max (R &&range) -> decltype (*max_element (range))
{
  return *max_element (range);
}

template <typename R, typename C>
inline auto max (R &&range, C comp) -> decltype (*max_element (range, comp))
{
  return *max_element (range);
}
