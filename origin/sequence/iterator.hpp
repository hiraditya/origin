...
template <typename I, typename P> class filter_iterator
{
...
inline filter_iterator<I, P>::filter_iterator (I first, I last, P pred)
    : data (std::find_if (first, last, pred), last, pred)
{
}

template <typename I, typename P>
inline filter_iterator<I, P>::filter_iterator (I last, P pred)
    : data (last, last, pred)
{
}

template <typename I, typename P>
inline auto filter_iterator<I, P>::operator* () const -> reference
{
  return *first ();
}

template <typename I, typename P>
inline auto filter_iterator<I, P>::operator-> () const -> pointer
{
  return &operator* ();
}

template <typename I, typename P>
inline filter_iterator<I, P> &filter_iterator<I, P>::operator++ ()
{
  advance ();
  return *this;
}
...
template <typename I, typename P>
inline filter_iterator<I, P> filter_iterator<I, P>::operator++ (int)
{
  I tmp = first ();
  advance ();
