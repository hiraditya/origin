...
template <typename T, typename H> struct handle_counter
{
  using handle_type = H;
  using counter_type = T;

  handle_counter (counter_type n) : count (n) {}
...
inline handle_counter<C, H> &handle_counter<C, H>::operator++ ()
{
  ++count;
  return *this;
}
...
template <typename C, typename H>
inline handle_counter<C, H> handle_counter<C, H>::operator++ (int)
{
...
template <typename E> using edge_set = std::vector<edge<E> >;
...
template <typename V> using vertex_set = std::vector<vertex<V> >;
...
public:
  ...
  template <typename... Args> vertex emplace_vertex (Args &&...);
...
inline auto directed_adjacency_vector<V, E>::operator() (vertex u,
                                                         vertex v) const
    -> edge
{
...
template <typename V, typename E>
inline auto directed_adjacency_vector<V, E>::find_out_edge (vertex u,
                                                            vertex v) const
    -> edge
{
...
template <typename V, typename E>
inline auto directed_adjacency_vector<V, E>::find_in_edge (vertex u,
                                                           vertex v) const
    -> edge
{
...
template <typename V, typename E>
template <typename S, typename P>
inline auto directed_adjacency_vector<V, E>::find_edge (const S &seq,
                                                        P pred) const -> edge
{
...
template <typename V, typename E>
inline auto directed_adjacency_vector<V, E>::add_vertex () -> vertex
{
  return emplace_vertex ();
}

template <typename V, typename E>
inline auto directed_adjacency_vector<V, E>::add_vertex (V &&x) -> vertex
{
  return emplace_vertex (std::move (x));
}

template <typename V, typename E>
inline auto directed_adjacency_vector<V, E>::add_vertex (const V &x) -> vertex
{
...
template <typename V, typename E>
template <typename... Args>
inline auto directed_adjacency_vector<V, E>::emplace_vertex (Args &&... args)
    -> vertex
{
...
template <typename V, typename E>
inline auto directed_adjacency_vector<V, E>::add_edge (vertex u, vertex v)
    -> edge
{
...
template <typename V, typename E>
template <typename... Args>
inline auto directed_adjacency_vector<V, E>::emplace_edge (vertex u, vertex v,
                                                           Args &&... args)
    -> edge
{
  edge e = edges_.size ();
...
template <typename V, typename E>
inline auto directed_adjacency_vector<V, E>::vertices () const -> vertex_range
{
...
template <typename V, typename E>
inline auto directed_adjacency_vector<V, E>::edges () const -> edge_range
{
...
template <typename V, typename E>
inline auto directed_adjacency_vector<V, E>::out_edges (vertex v) const
    -> incidence_range
{
...
template <typename V, typename E>
inline auto directed_adjacency_vector<V, E>::in_edges (vertex v) const
    -> incidence_range
{
  const vertex_node &vn = node (v);
...
template <typename V, typename E>
inline auto undirected_adjacency_vector<V, E>::operator() (vertex u,
                                                           vertex v) const
    -> edge
{
...
template <typename V, typename E>
inline auto undirected_adjacency_vector<V, E>::find_edge (vertex u,
                                                          vertex v) const
    -> edge
{
...
template <typename V, typename E>
template <typename S, typename P>
inline auto undirected_adjacency_vector<V, E>::find_endpoints (const S &seq,
                                                               P pred) const
    -> edge
{
  auto i = find_if (seq, pred);
...
// V is a user-supplied type, its value is default constructed.
template <typename V, typename E>
inline auto undirected_adjacency_vector<V, E>::add_vertex () -> vertex
{
  return emplace_vertex ();
}

template <typename V, typename E>
inline auto undirected_adjacency_vector<V, E>::add_vertex (V &&x) -> vertex
{
  return emplace_vertex (std::move (x));
}

template <typename V, typename E>
inline auto undirected_adjacency_vector<V, E>::add_vertex (const V &x)
    -> vertex
{
  return emplace_vertex (x);
}
...
template <typename V, typename E>
template <typename... Args>
inline auto undirected_adjacency_vector<V, E>::emplace_vertex (Args &&... args)
    -> vertex
{
...
// Add a defaul edge from u to v.
template <typename V, typename E>
inline auto undirected_adjacency_vector<V, E>::add_edge (vertex u, vertex v)
    -> edge
{
  return emplace_edge (u, v);
}
...
template <typename V, typename E>
template <typename... Args>
inline auto undirected_adjacency_vector<V, E>::emplace_edge (vertex u,
                                                             vertex v,
                                                             Args &&... args)
    -> edge
{
...
// Retrun a range over the vertex set.
template <typename V, typename E>
inline auto undirected_adjacency_vector<V, E>::vertices () const
    -> vertex_range
{
  return { vertex_iter (verts_.begin ()), vertex_iter (verts_.end ()) };
}
...
// Return a range over the edge set.
template <typename V, typename E>
inline auto undirected_adjacency_vector<V, E>::edges () const -> edge_range
{
  return { edge_iter (edges_.begin ()), edge_iter (edges_.end ()) };
}
...
// Return a range over the out edges of the vertex v.
template <typename V, typename E>
inline auto undirected_adjacency_vector<V, E>::edges (vertex v) const
    -> incidence_range
{
  const vertex_node &vn = node (v);
