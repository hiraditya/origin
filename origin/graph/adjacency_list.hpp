...
template <typename C, typename H> struct handle_accessor;

template <typename T, typename H> struct handle_accessor<pool<T>, H>
{
...
template <typename T, typename H> struct handle_accessor<std::vector<T>, H>
{
...
struct handle_iterator : handle_accessor<C, H>
{
  ...
  handle_iterator (iterator i) : iter (i) {}
...
template <typename C, typename H>
inline handle_iterator<C, H> &handle_iterator<C, H>::operator++ ()
{
  ++iter;
  return *this;
}
...
template <typename C, typename H>
inline handle_iterator<C, H> handle_iterator<C, H>::operator++ (int)
{
...
template <typename E> struct edge
{
  ...
  edge (vertex_handle s, vertex_handle t) : data (s, t, E{}) {}
...
template <typename E> using edge_pool = pool<edge<E> >;
...
template <typename E> using edge_range = bounded_range<edge_iterator<E> >;
...
template <typename V> struct vertex
{
  ...
  void
  insert_out (edge_handle e)
  {
    insert_edge (out (), e);
  }
  void
  erase_out (edge_handle e)
  {
    erase_edge (out (), e);
  }
  ...
  void
  insert_in (edge_handle e)
  {
    insert_edge (in (), e);
  }
  void
  erase_in (edge_handle e)
  {
    erase_edge (in (), e);
  }
...
template <typename V> using vertex_pool = pool<vertex<V> >;
...
template <typename V> using vertex_range = bounded_range<vertex_iterator<V> >;
...
public:
  ...
  // Vertex observers
  std::size_t
  out_degree (vertex v) const
  {
    return node (v).out_degree ();
  }
  std::size_t
  in_degree (vertex v) const
  {
    return node (v).in_degree ();
  }
  std::size_t
  degree (vertex v) const
  {
  ...
  source (edge e) const
  {
    return get_edge (e).source ();
  }
  vertex
  target (edge e) const
  {
    return get_edge (e).target ();
  }
  ...
  template <typename... Args> vertex emplace_vertex (Args &&... args);
...
private:
  ...
  template <typename S, typename P> void unlink_first_edge (S &seq, P pred);
...
inline auto directed_adjacency_list<V, E>::operator() (vertex u,
                                                       vertex v) const -> edge
{
...
template <typename V, typename E>
inline auto directed_adjacency_list<V, E>::find_out_edge (vertex u,
                                                          vertex v) const
    -> edge
{
...
template <typename V, typename E>
inline auto directed_adjacency_list<V, E>::find_in_edge (vertex u,
                                                         vertex v) const
    -> edge
{
...
template <typename V, typename E>
template <typename S, typename P>
inline auto directed_adjacency_list<V, E>::find_edge (const S &seq,
                                                      P pred) const -> edge
{
...
template <typename V, typename E>
inline auto directed_adjacency_list<V, E>::add_vertex () -> vertex
{
  return verts_.emplace ();
}

template <typename V, typename E>
inline auto directed_adjacency_list<V, E>::add_vertex (V &&x) -> vertex
{
  return verts_.emplace (std::move (x));
}

template <typename V, typename E>
inline auto directed_adjacency_list<V, E>::add_vertex (const V &x) -> vertex
{
...
template <typename V, typename E>
template <typename... Args>
inline auto directed_adjacency_list<V, E>::emplace_vertex (Args &&... args)
    -> vertex
{
...
template <typename V, typename E>
inline auto directed_adjacency_list<V, E>::add_edge (vertex u, vertex v)
    -> edge
{
...
template <typename V, typename E>
inline auto directed_adjacency_list<V, E>::add_edge (vertex u, vertex v, E &&x)
    -> edge
{
...
template <typename V, typename E>
template <typename... Args>
inline auto directed_adjacency_list<V, E>::emplace_edge (vertex u, vertex v,
                                                         Args &&... args)
    -> edge
{
...
template <typename V, typename E>
inline auto directed_adjacency_list<V, E>::vertices () const -> vertex_range
{
...
template <typename V, typename E>
inline auto directed_adjacency_list<V, E>::edges () const -> edge_range
{
...
template <typename V, typename E>
inline auto directed_adjacency_list<V, E>::out_edges (vertex v) const
    -> incidence_range
{
...
template <typename V, typename E>
inline auto directed_adjacency_list<V, E>::in_edges (vertex v) const
    -> incidence_range
{
  const vertex_node &vn = node (v);
...
private:
  ...
  template <typename S, typename I> void erase_loop (S &seq, I iter);
...
template <typename V, typename E>
inline auto undirected_adjacency_list<V, E>::operator() (vertex u,
                                                         vertex v) const
    -> edge
{
...
template <typename V, typename E>
inline auto undirected_adjacency_list<V, E>::find_edge (vertex u,
                                                        vertex v) const -> edge
{
...
template <typename V, typename E>
template <typename S, typename P>
inline auto undirected_adjacency_list<V, E>::find_endpoints (const S &seq,
                                                             P pred) const
    -> edge
{
  auto i = find_if (seq, pred);
...
// V is a user-supplied type, its value is default constructed.
template <typename V, typename E>
inline auto undirected_adjacency_list<V, E>::add_vertex () -> vertex
{
  return verts_.emplace ();
}

template <typename V, typename E>
inline auto undirected_adjacency_list<V, E>::add_vertex (V &&x) -> vertex
{
  return verts_.emplace (std::move (x));
}

template <typename V, typename E>
inline auto undirected_adjacency_list<V, E>::add_vertex (const V &x) -> vertex
{
  return verts_.emplace (x);
}
...
template <typename V, typename E>
template <typename... Args>
inline auto undirected_adjacency_list<V, E>::emplace_vertex (Args &&... args)
    -> vertex
{
  return verts_.emplace (std::forward<Args> (args)...);
}
...
// Add a defaul edge from u to v.
template <typename V, typename E>
inline auto undirected_adjacency_list<V, E>::add_edge (vertex u, vertex v)
    -> edge
{
  return emplace_edge (u, v);
}
...
template <typename V, typename E>
template <typename... Args>
inline auto undirected_adjacency_list<V, E>::emplace_edge (vertex u, vertex v,
                                                           Args &&... args)
    -> edge
{
  edge e = edges_.emplace (u, v, std::forward<Args> (args)...);
...
template <typename S, typename I>
inline void
undirected_adjacency_list<V, E>::erase_edge (S &seq1, I iter1, S &seq2,
                                             I iter2)
{
  edges_.erase (*iter1);
  seq1.erase (iter1);
...
// Retrun a range over the vertex set.
template <typename V, typename E>
inline auto undirected_adjacency_list<V, E>::vertices () const -> vertex_range
{
  return { vertex_iter (verts_.begin ()), vertex_iter (verts_.end ()) };
}
...
// Return a range over the edge set.
template <typename V, typename E>
inline auto undirected_adjacency_list<V, E>::edges () const -> edge_range
{
  return { edge_iter (edges_.begin ()), edge_iter (edges_.end ()) };
}
...
// Return a range over the out edges of the vertex v.
template <typename V, typename E>
inline auto undirected_adjacency_list<V, E>::edges (vertex v) const
    -> incidence_range
{
  const vertex_node &vn = node (v);
