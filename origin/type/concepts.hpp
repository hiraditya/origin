...
Movable ()
{
  return Destructible<T> () && Move_constructible<T> ()
         && Move_assignable<T> ();
}
...
template <typename T> struct difference_type_traits
{
