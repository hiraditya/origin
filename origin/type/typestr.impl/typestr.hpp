...
template <typename T> struct typestr_dispatch<T>
{
  std::string
  operator() () const
  {
...
template <typename T> struct type_to_string<const T>
{
  std::string
  operator() () const
  {
...
template <typename T> struct type_to_string<volatile T>
{
  std::string
  operator() () const
  {
...
template <typename T> struct type_to_string<const volatile T>
{
  std::string
  operator() () const
  {
...
template <typename T> struct type_to_string<T *>
{
  std::string
  operator() () const
  {
...
template <typename T> struct type_to_string<T *const>
{
  std::string
  operator() () const
  {
...
template <typename T> struct type_to_string<T *volatile>
{
  std::string
  operator() () const
  {
...
template <typename T> struct type_to_string<T *const volatile>
{
  std::string
  operator() () const
  {
...
template <typename R, typename... Args> struct type_to_string<R (Args...)>
{
  std::string
  operator() () const
  {
...
template <typename T, std::size_t N> struct type_to_string<T[N]>
{
  std::string
  operator() () const
  {
...
template <typename T, typename... Args> struct typelist_to_string<T, Args...>
{
  std::string
  operator() () const
  {
...
template <typename T> struct typelist_to_string<T>
{
  std::string
  operator() () const
  {
...
template <> struct typelist_to_string<>
{
  std::string
  operator() () const
  {
