...
template <typename T, typename... Args> struct front_type<T, Args...>
{
  using type = T;
};
...
struct front_type<Expand<Template<Args...> > > : front_type<Args...>
{
};
...
template <typename T> struct back_type<T>
{
  using type = T;
};
...
template <template <typename...> class Template, typename... Args>
struct back_type<Expand<Template<Args...> > > : back_type<Args...>
{
};
...
struct are_same<Expand<Template<Args...> > > : are_same<Args...>
{
};
